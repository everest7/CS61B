package com.homework3;/* com.homework3.SList.java */

/**
 *  The com.homework3.SList class is a singly-linked implementation of the linked list
...
public class SList {
    ...
    /**
     *  com.homework3.SList() constructs an empty list.
     **/
    ...
    /**
     *  main() runs test cases on the com.homework3.SList class.  Prints summary
    ...
    public static void main (String[] args) {
        ...
        SList original = new SList();
        original.insertFront("12");
        original.insertFront("9");
        original.insertFront("6");
        System.out.println("Here is a list after construction: "+original.toString());

        original.insertFront("3");
        original.insertEnd("15");
        System.out.println("Here is a list after change: " + original.toString());
