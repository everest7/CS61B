package com.project1;/* PixImage.java */
...
public class PixImage {
  ...
  public PixImage boxBlur(int numIterations) {
    ...
    for (int num = 1; num <= numIterations; num++){
        newImage = new PixImage(width,height);
        for (int i = 0; i < width; i++){
            for (int j = 0; j < height; j++){
                if (i==0 && j==0){
                    rnew = (prevImage.r[i][j] + prevImage.r[i][j+1] + prevImage.r[i+1][j] + prevImage.r[i+1][j+1])/4;
                    gnew = (prevImage.g[i][j] + prevImage.g[i][j+1] + prevImage.g[i+1][j] + prevImage.g[i+1][j+1])/4;
                    bnew = (prevImage.b[i][j] + prevImage.b[i][j+1] + prevImage.b[i+1][j] + prevImage.b[i+1][j+1])/4;
                    ...
                    rnew = (prevImage.r[i][j] + prevImage.r[i][j+1] + prevImage.r[i][j-1] + prevImage.r[i+1][j] + prevImage.r[i+1][j+1] + prevImage.r[i+1][j-1])/6;
                    gnew = (prevImage.g[i][j] + prevImage.g[i][j+1] + prevImage.g[i][j-1] + prevImage.g[i+1][j] + prevImage.g[i+1][j+1] + prevImage.g[i+1][j-1])/6;
                    bnew = (prevImage.b[i][j] + prevImage.b[i][j+1] + prevImage.b[i][j-1] + prevImage.b[i+1][j] + prevImage.b[i+1][j+1] + prevImage.b[i+1][j-1])/6;
                } else if (i==width-1){
                    rnew = (prevImage.r[i][j] + prevImage.r[i][j+1] + prevImage.r[i][j-1] + prevImage.r[i-1][j] + prevImage.r[i-1][j+1] + prevImage.r[i-1][j-1])/6;
                    gnew = (prevImage.g[i][j] + prevImage.g[i][j+1] + prevImage.g[i][j-1] + prevImage.g[i-1][j] + prevImage.g[i-1][j+1] + prevImage.g[i-1][j-1])/6;
                    bnew = (prevImage.b[i][j] + prevImage.b[i][j+1] + prevImage.b[i][j-1] + prevImage.b[i-1][j] + prevImage.b[i-1][j+1] + prevImage.b[i-1][j-1])/6;
                } else if (j==0){
                    rnew = (prevImage.r[i][j] + prevImage.r[i][j+1] + prevImage.r[i-1][j] + prevImage.r[i+1][j] + prevImage.r[i+1][j+1] + prevImage.r[i-1][j+1])/6;
                    gnew = (prevImage.g[i][j] + prevImage.g[i][j+1] + prevImage.g[i-1][j] + prevImage.g[i+1][j] + prevImage.g[i+1][j+1] + prevImage.g[i-1][j+1])/6;
                    bnew = (prevImage.b[i][j] + prevImage.b[i][j+1] + prevImage.b[i-1][j] + prevImage.b[i+1][j] + prevImage.b[i+1][j+1] + prevImage.b[i-1][j+1])/6;
                } else if (j==height-1){
                    rnew = (prevImage.r[i][j] + prevImage.r[i][j-1] + prevImage.r[i-1][j] + prevImage.r[i+1][j] + prevImage.r[i+1][j-1] + prevImage.r[i-1][j-1])/6;
                    gnew = (prevImage.g[i][j] + prevImage.g[i][j-1] + prevImage.g[i-1][j] + prevImage.g[i+1][j] + prevImage.g[i+1][j-1] + prevImage.g[i-1][j-1])/6;
                    bnew = (prevImage.b[i][j] + prevImage.b[i][j-1] + prevImage.b[i-1][j] + prevImage.b[i+1][j] + prevImage.b[i+1][j-1] + prevImage.b[i-1][j-1])/6;
                } else {
                    rnew = (prevImage.r[i][j] + prevImage.r[i+1][j] + prevImage.r[i][j+1] + prevImage.r[i-1][j] + prevImage.r[i][j-1] + prevImage.r[i+1][j+1] + prevImage.r[i-1][j+1] + prevImage.r[i+1][j-1] + prevImage.r[i-1][j-1])/9;
                    gnew = (prevImage.g[i][j] + prevImage.g[i+1][j] + prevImage.g[i][j+1] + prevImage.g[i-1][j] + prevImage.g[i][j-1] + prevImage.g[i+1][j+1] + prevImage.g[i-1][j+1] + prevImage.g[i+1][j-1] + prevImage.g[i-1][j-1])/9;
                    bnew = (prevImage.b[i][j] + prevImage.b[i+1][j] + prevImage.b[i][j+1] + prevImage.b[i-1][j] + prevImage.b[i][j-1] + prevImage.b[i+1][j+1] + prevImage.b[i-1][j+1] + prevImage.b[i+1][j-1] + prevImage.b[i-1][j-1])/9;
                }
                newImage.setPixel(i,j,(short)rnew,(short)gnew,(short)bnew);
            }
