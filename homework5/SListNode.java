...
/**
 *  An SListNode is a mutable node in an com.homework3.SList (singly-linked list).
 **/
...
public class SListNode extends ListNode {
   ...
   *  next references the next node in the com.homework3.SList.
   *
  ...
  /**
   *  remove() removes this node from its com.homework3.SList.  If this node is invalid,
   *  throws an exception.
   *
   *  @exception InvalidNodeException if this node is not valid.
   *
