/* com.homework3.SList.java */

package com.homework5;

/**
 *  A com.homework3.SList is a mutable singly-linked list ADT.  Its implementation employs
 *  a tail reference.
 *
...
public class SList extends List {
  ...
  /* com.homework3.SList invariants:
   ...
   *  3)  For every SListNode x in an com.homework3.SList l, x.myList = l.
   **/
   ...
   *  That way, only this method need be overridden if a subclass of com.homework3.SList
  ...
  /**
   *  com.homework3.SList() constructs for an empty com.homework3.SList.
   **/
  public SList() {
    head = null;
    tail = null;
  ...
  /**
   *  insertFront() inserts an item at the front of this com.homework3.SList.
   *
  ...
  /**
   *  insertBack() inserts an item at the back of this com.homework3.SList.
   *
   *  @param item is the item to be inserted.
   *
   *  Performance:  runs in O(1) time.
  ...
  /**
   *  front() returns the node at the front of this com.homework3.SList.  If the com.homework3.SList is
   *  empty, return an "invalid" node--a node with the property that any
   *  attempt to use it will cause an exception.
   *
   *  @return a ListNode at the front of this com.homework3.SList.
   *
   *  Performance:  runs in O(1) time.
   */
  ...
  /**
   *  back() returns the node at the back of this com.homework3.SList.  If the com.homework3.SList is
   *  empty, return an "invalid" node--a node with the property that any
   *  attempt to use it will cause an exception.
   *
   *  @return a ListNode at the back of this com.homework3.SList.
   *
   *  Performance:  runs in O(1) time.
   */
  ...
  /**
   *  toString() returns a String representation of this com.homework3.SList.
   *
   *  @return a String representation of this com.homework3.SList.
   *
